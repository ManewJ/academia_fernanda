...
public class Main {
    private static ArrayList<Professor.Aluno> alunos = new ArrayList<>();
    ...
    public static void main(String[] args) {
        ...
        do {
            System.out.println("\n=== Sistema da Academia ===");
            System.out.println("1. Cadastrar Professor.Aluno");
    ...
    private static void cadastrarAluno() {
        ...
        alunos.add(new Professor.Aluno(nome, idade, cpf, genero, endereco, plano, nivelTreino, frequencia));
        System.out.println("models.Professor.Aluno cadastrado com sucesso!");
    }
    ...
    private static void listarAlunos() {
        if (alunos.isEmpty()) {
            ...
            for (Professor.Aluno aluno : alunos) {
    ...
    private static void cadastrarPersonal() {
        ...
        System.out.println("models.Personal cadastrado com sucesso!");
    }
    ...
    private static void registrarPagamentoAluno() {
        ...
        System.out.println("models.Professor.Aluno não encontrado.");
    }
    ...
    private static void atenderAlunoComPersonal() {
        ...
        for (Personal personal : personals) {
            if (personal.getNome().equalsIgnoreCase(nomePersonal)) {
                ...
                System.out.println("models.Professor.Aluno atendido pelo personal " + personal.getNome());
                return;
            }
        }
        System.out.println("models.Personal não encontrado.");
    }
}
